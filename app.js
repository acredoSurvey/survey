...
(function () {
  ...
  function revealTiming() {
    ...
    return {
      ...
      askDwell: t.askDwell != null ? t.askDwell : 1100,
      ...
      askEnterFade: t.askEnterFade != null ? t.askEnterFade : 950,
  ...
  function spawnOnePolaroid(cfg, opts) {
    ...
    const opacity = randBetween(0.46, 0.58);
    ...
    if (opts && opts.static) {
      ...
      el.style.opacity = String(Math.min(0.85, opacity));
    } else {
      ...
      if (isAsk) {
        ...
        fadeOutFocus(() => {
          after(t.askBefore, () => {
            ...
            const enterMs =
              t.askEnterFade != null ? t.askEnterFade : 950;
